...
export default function SchAppointments() {
  ...
  try {
    ...
    // Always navigate, even if no matching sessions
    navigate("/availability", { state: { results: res.data.results, otherSessions: res.data.otherSessions, message: res.data.message } });
  } catch (err) {
